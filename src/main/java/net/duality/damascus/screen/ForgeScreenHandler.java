...
public class ForgeScreenHandler extends ScreenHandler {
    ...
    public ForgeScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.addSlot(new Slot(inventory, 1,36,26));
        this.addSlot(new Slot(inventory, 2,124,26));
        this.addSlot(new Slot(inventory, 3,51,54));
        this.addSlot(new Slot(inventory, 4,109,54));
        this.addSlot(new Slot(inventory, 5,80,36));
