package net.duality.damascus.block.custom;

import com.mojang.serialization.MapCodec;
import net.duality.damascus.block.entity.ForgeBlockEntity;
...
public class ForgeBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.FORGE_BE, (world1, pos, state1, blockEntity) -> blockEntity.tick(world1, pos, state1));
    }
}
